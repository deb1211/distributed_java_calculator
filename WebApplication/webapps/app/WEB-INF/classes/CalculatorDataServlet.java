...
@WebServlet("/expressionoperation1")
public class CalculatorDataServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        for (Message messageSQS : listMessages) {
            List<String> expressionParameters = new LinkedList<String>(List.of(messageSQS.body().split(",")));
            String dataExpressionID = expressionParameters.get(3);
        }
        CalculorDataExpression retrieveddataExpression = CalculatorDataStorage.getCalculatorDataStorage().getCalculatorDataExpression(expressionID);
